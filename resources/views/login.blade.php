...
<header class="bg-white px-[5%] py-4 border-b border-gray-100 top-0 z-50">
    ...
    <main class="flex min-h-[85vh] w-full">
        ...
        <div class="flex-[2] bg-white flex justify-center items-center p-6 md:p-10">
            <div class="bg-zinc-100 p-10 md:p-14 rounded-3xl w-full max-w-lg text-center shadow-sm">
                
                <h1 class="text-4xl font-black mb-10 uppercase tracking-tighter">Prihlásenie</h1>
                
                    <form action="/login" method="POST">
                        @csrf <div class="text-left mb-6">
                            <label class="block text-sm font-bold uppercase tracking-wider mb-2 text-gray-800">E-mail</label>
                            <input type="email" 
                                name="email" 
                                required
                                class="w-full p-4 rounded-full border-0 bg-white shadow-sm outline-none focus:ring-2 focus:ring-red-600 transition-all">
                        </div>

                        <div class="text-left mb-8">
                            <label class="block text-sm font-bold uppercase tracking-wider mb-2 text-gray-800">Heslo</label>
                            <div class="relative">
                                <input type="password" 
                                    name="password" 
                                    required
                                    class="w-full p-4 rounded-full border-0 bg-white shadow-sm outline-none focus:ring-2 focus:ring-red-600 transition-all pr-12">
                        ...
                        <button type="submit" 
                                class="w-full bg-red-600 text-white font-bold py-4 rounded-full uppercase tracking-widest hover:bg-black transition-all shadow-lg active:scale-95">
                            Prihlásiť sa
                        </button>
                    </form>
                ...
                <p class="mt-8 text-gray-500 text-sm">
                    Nemáte ešte účet? 
                    <a href="/registration" class="whitespace-nowrap font-bold text-zinc-950 uppercase tracking-wider ml-1 hover:text-red-600 transition-colors underline decoration-2 underline-offset-4">
                        Zaregistrujte sa
                    </a>
                </p>
